            ...
            <form action="{{ route('moa.update', $moa) }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="date" name="valid_until" id="valid_until" value="{{ old('valid_until', $moa->valid_until?->format('Y-m-d')) }}" required class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all @error('valid_until') border-red-500 @enderror">
