            ...
            <div class="flex items-center justify-between h-16">
                <div class="flex items-center">
                    <a href="/" class="flex items-center space-x-2.5 group">
                        <div class="w-9 h-9 rounded-lg flex items-center justify-center shadow-sm group-hover:shadow-md transition-shadow bg-white">
                            <img src="{{ asset('images/FPRDI-Logo.png') }}" alt="FPRDI Logo" class="w-7 h-7 object-contain" />
                        </div>
                        <span class="text-lg font-semibold text-gray-900 group-hover:text-blue-600 transition-colors">InternTrack</span>
                    </a>
                ...
                <div class="flex items-center">
                    <img src="{{ asset('images/Hi-Res-BAGONG-PILIPINAS-LOGO.png') }}" alt="Bagong Pilipinas Logo" class="h-16 w-auto object-contain" />
                </div>
            </div>
        </div>
    </nav>
